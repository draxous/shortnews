...
class MultiPagerAdapter(
...
) : RecyclerView.Adapter<MultiPagerAdapter.PagerViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): PagerViewHolder =
        PagerViewHolder(
            LayoutInflater.from(parent.context).inflate(R.layout.single_multipage_ad, parent, false)
        )
    ...
    override fun onBindViewHolder(holder: PagerViewHolder, position: Int) {
        Glide.with(context)
            ...
            .into(holder.itemView.ad_image)

        holder.itemView.ad_image.setOnTouchListener { v, _ -> false }
        ...
        val mGestureDetector = GestureDetector(
            ...
            object : CustomGestureListener(itemView) {
                ...
                override fun onTouch(): Boolean {
                    ...
                    eventTriggerListener.onEventTriggered(Event.OnShareCard(itemView.ad_image, null))
                    return false
                }
            })
    ...
    private fun firebaseEvenLog(adsModel: AdsModel?) {
        ...
        firebaseAnalytics.logEvent("multipage__share", bundle)
    }
