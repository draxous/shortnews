...
public class ViewPagerParallax implements ViewPager.PageTransformer {

    private List<ParallaxTransformInformation> mViewsToParallax
            = new ArrayList<ParallaxTransformInformation>();

    public ViewPagerParallax() {
    }

    public ViewPagerParallax(@NotNull List<ParallaxTransformInformation> viewsToParallax) {
        mViewsToParallax = viewsToParallax;
    }

    public ViewPagerParallax addViewToParallax(
